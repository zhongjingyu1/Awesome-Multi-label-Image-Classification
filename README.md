...
|[NUS-WIDE](https://drive.google.com/file/d/0B7IzDz-4yH_HMFdiSE44R1lselE/view?resourcekey=0-w5zM4GH9liG3rtoZoWzXag) (`NW`)|81|125,449|83898|2.4|
...
|[Visual Genome](https://homes.cs.washington.edu/~ranjay/visualgenome/index.html) (`VG500`)|500|75,774|32,475|-|
|[Visual Genome](https://github.com/zhongjingyu1/CoNeS/tree/master/Dataset/VG) (`VG256`)|256|75,774|32,475|-|
...
|**[DRTN]**[DRTN: Dual Relation Transformer Network with feature erasure and contrastive learning for multi-label image classification](https://www.sciencedirect.com/science/article/abs/pii/S0893608025001881)|NN|2025|`NW`,`COCO`,`VOC07`|-|
|[]()||||[Official]()|
